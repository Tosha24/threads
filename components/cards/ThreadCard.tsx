...
interface Props {
  ...
  }[]; // Comments is of type array with author property having only image because we only need the image of the author who commented while displaying threads on the Threads page.
  isComment?: boolean;
}
